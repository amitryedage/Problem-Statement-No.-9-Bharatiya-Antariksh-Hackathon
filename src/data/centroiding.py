#Task that excute in the given section is 
# extract_subapertures() — splits a BMP frame into 100 lenslet patches(Help to work on the small section to work more efficiently)
